...
import { BiLoderCircle } from "react-icons/bi";
      ...
      <div id="MainHeader" className="border-b">
        <div className="flex items-center justify-between w-full mx-auto max-w-[1200px]">
          <div className="flex items-center w-full bg-white">
            <div className="flex items-center lg:justify-between gap-10 max-w-[1150px] w-full px-3 py-4 mx-auto">
              <Link href="/">
                <img width="120" src="/images/1200px-EBay_logo.svg.png" />
              </Link>
